...
public class CurvingBehaviour extends BeltProcessingBehaviour {
	...
	public <T extends SmartBlockEntity & CurvingBehaviourSpecifics> CurvingBehaviour(T be) {
		super(be);
		this.specifics = be;
		mode = Mode.WORLD;
		entityScanCooldown = ENTITY_SCAN;
		whenItemEnters((s, i) -> BeltCurvingCallbacks.onItemReceived(s, i, this));
		whileItemHeld((s, i) -> BeltCurvingCallbacks.whenItemHeld(s, i, this));
	}
