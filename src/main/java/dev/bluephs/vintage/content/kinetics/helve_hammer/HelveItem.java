...
public class HelveItem extends BlockItem {
	...
	public void showBounds(BlockPlaceContext context) {
		...
		Outliner.getInstance().showAABB(Pair.of("helve_hammer", pos), new AABB(pos.relative(context.getHorizontalDirection())).inflate((direction == Direction.NORTH || direction == Direction.SOUTH ? 0 : xOffset), 0, (direction == Direction.NORTH || direction == Direction.SOUTH ? xOffset : 0))
