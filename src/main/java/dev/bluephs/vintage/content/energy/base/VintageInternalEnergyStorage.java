package dev.bluephs.vintage.content.energy.base;
...
public class VintageInternalEnergyStorage extends EnergyStorage {

	public VintageInternalEnergyStorage(int capacity) {
        super(capacity, capacity, capacity, 0);
    }

    public VintageInternalEnergyStorage(int capacity, int maxTransfer) {
        super(capacity, maxTransfer, maxTransfer, 0);
    }

    public VintageInternalEnergyStorage(int capacity, int maxReceive, int maxExtract) {
        super(capacity, maxReceive, maxExtract, 0);
    }

    public VintageInternalEnergyStorage(int capacity, int maxReceive, int maxExtract, int energy) {
