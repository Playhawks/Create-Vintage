...
import static dev.bluephs.vintage.foundation.data.recipe.VintageCompatMetals.*;
import dev.bluephs.vintage.content.equipment.*;
import dev.bluephs.vintage.content.kinetics.lathe.recipe_card.RecipeCardItem;
import dev.bluephs.vintage.foundation.data.recipe.VintageCompatMetals;
