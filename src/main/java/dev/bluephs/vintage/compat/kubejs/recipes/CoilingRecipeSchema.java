 ...
 */
public interface CoilingRecipeSchema {
	...
	RecipeKey<String> SPRING_COLOR = StringComponent.ANY.key("springColor").optional("828282");
	...
	class ProcessingRecipeJS extends RecipeJS {
		...
		public RecipeJS springColor(String color) {
			return setValue(SPRING_COLOR, color);
		}
	}

	RecipeSchema COILING_PROCESSING = new RecipeSchema(ProcessingRecipeJS.class, ProcessingRecipeJS::new, RESULTS, INGREDIENTS, PROCESSING_TIME_REQUIRED, SPRING_COLOR);
}
