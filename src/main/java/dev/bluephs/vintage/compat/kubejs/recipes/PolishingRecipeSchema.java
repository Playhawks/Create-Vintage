...
public interface PolishingRecipeSchema {
	...
	RecipeKey<Integer> SPEED_LIMITS = NumberComponent.IntRange.INT.key("speedLimits").optional(0);
	...
	class ProcessingRecipeJS extends RecipeJS {
		...
		public RecipeJS speedLimits(int limits) {
			return setValue(SPEED_LIMITS, limits);
		}
	}

	RecipeSchema POLISHING_PROCESSING = new RecipeSchema(ProcessingRecipeJS.class, ProcessingRecipeJS::new, RESULTS, INGREDIENTS, PROCESSING_TIME_REQUIRED, SPEED_LIMITS, FRAGILE);
}
