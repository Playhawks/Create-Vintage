...
public interface CentrifugationRecipeSchema {
    ...
    RecipeKey<Integer> MINIMAL_RPM_REQUIREMENTS = NumberComponent.IntRange.INT.key("minimalRPM").optional(100);
    ...
    class ProcessingRecipeJS extends RecipeJS {
        ...
        public RecipeJS minimalRPM(int rpm) {
            return setValue(MINIMAL_RPM_REQUIREMENTS, rpm);
        }
    }

    RecipeSchema CENTRIFUGATION_PROCESSING = new RecipeSchema(ProcessingRecipeJS.class, ProcessingRecipeJS::new, RESULTS, INGREDIENTS, PROCESSING_TIME_REQUIRED, MINIMAL_RPM_REQUIREMENTS);
}
